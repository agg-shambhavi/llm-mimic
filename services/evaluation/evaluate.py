...
model_ids = [
    check_if_huggingface_model_exists(
        f"{MODEL_HUGGINGFACE_WORKSPACE}/MimicLlama-3.1-8B", default_value="agg-shambhavi/MimicLlama-3.1-8B"
    ),
    check_if_huggingface_model_exists(
        f"{MODEL_HUGGINGFACE_WORKSPACE}/MimicLlama-3.1-8B-DPO", default_value="agg-shambhavi/MimicLlama-3.1-8B-DPO"
    ),
...
if __name__ == "__main__":
    ...
    for model_id in model_ids:
        dataset_name = check_if_huggingface_dataset_exists(
            f"{DATASET_HUGGINGFACE_WORKSPACE}/llm-mimic-instruct", default_value="agg-shambhavi/llm-mimic-instruct"
        )
