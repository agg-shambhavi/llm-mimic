...
from services.preprocessing.embeddings import EmbeddingModelSingleton
from utils.exceptions_def import ImproperlyConfigured
from data_models.documents import DataCategory
from services.db.qdrant import connection
